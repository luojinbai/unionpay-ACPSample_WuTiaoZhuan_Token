...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan_Token/form03_6_2_Token_OpenCard_Back" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>卡号：</label>
<input id="accNo" type="text" name="accNo" placeholder="开通的卡号" value="6221558812340000" title="测试环境使用测试卡" required="required"/>
</p>
<p>
<label>&nbsp;</label>
