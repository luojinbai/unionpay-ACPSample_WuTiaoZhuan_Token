...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan_Token/form03_6_4_Token_DeleteToken" target="_blank">
<p>
<label>商户号：</label>
...
<label>&nbsp;</label>
<input type="submit" class="button" value="解除标记" />
