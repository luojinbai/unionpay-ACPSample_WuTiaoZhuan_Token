...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan_Token/form03_6_5_Token_UpdateToken" target="_blank">
<p>
<label>商户号：</label>
...
<label>token号：</label>
<input id="token" type="text" name="token" placeholder="token号" value="" title="商户获取到的token号" required="required"/>
</p>
<p>


<label>&nbsp;</label>
<input type="submit" class="button" value="更新标记" />
