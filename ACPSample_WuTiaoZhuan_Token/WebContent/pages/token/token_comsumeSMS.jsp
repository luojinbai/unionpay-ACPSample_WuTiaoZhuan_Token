...
<form class="api-form" method="post" action="<%request.getContextPath();%>/ACPSample_WuTiaoZhuan_Token/form03_6_6_Token_ConsumeSMS" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>token号：</label>
<input id="token" type="text" name="token" placeholder="token号" value="" title="token号" required="required"/>
</p>
<p>
<label>&nbsp;</label>
